...
export const officialSite = "https://govpgcollarang.cgstate.gov.in";
...
export const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Principal Details", href: "/principal-details" },
      { label: "Janbhagidari Samiti", href: "/janbhagidari-samiti-details" },
      { label: "College Samiti", href: "/college-samiti" },
  ...
  },
  {
    ...
    items: [
      { label: "Course Details", href: "/course-details" },
      { label: "Syllabus", href: "/syllabus" },
      { label: "Calendar", href: "/calendar" },
      { label: "Admission Guideline", href: "/admission-guideline" },
      { label: "Fees Payment", href: "/fees-payment" },
      { label: "Student Union", href: "/student-union" },
    ],
  },
  {
    label: "Facilities",
    items: [
      ...
      { label: "Girls Common Room", href: "/girls-common-room" },
      { label: "Smart Class", href: "/smart-class" },
      { label: "Botanical Garden", href: "/botnical-garden" },
      { label: "Herbal Garden", href: "/harbal-garden" },
  ...
  },
  {
    label: "NAAC & Research",
    items: [
      { label: "IQAC", href: "/iqac-details" },
      { label: "AISHE", href: "/aish-details" },
      { label: "Important Links", href: "/important-link-details" },
      { label: "NAAC Feedback", href: "/naac-feedback-details" },
      { label: "SSR", href: "/ssr-details" },
      { label: "AQAR", href: "/aqar-details" },
      { label: "Peer Team Report", href: "/peer-team-report-details" },
      { label: "NAAC Certificate", href: "/naac-certificate-details" },
    ],
  },
  {
    label: "Exam & Gallery",
    items: [
      { label: "Unit Test", href: "/unit-test" },
      { label: "Result", href: "/result" },
      { label: "Time Table", href: "/time-table" },
      { label: "Notice Board", href: "/notice-board" },
      { label: "Events", href: "/event" },
      { label: "Award Gallery", href: "/award-gallery" },
      { label: "Activities Gallery", href: "/activities-gallery" },
      { label: "Other Gallery", href: "/other-gallery" },
      { label: "Contact", href: "/contact-us" },
    ],
  },
];
...
export const pages: Record<string, PageData> = {
  ...
  vision: {
    slug: "vision",
    title: "Vision",
    heroTag: "Value-Centered Learning",
    type: "text",
  ...
  mission: {
    slug: "mission",
    title: "Mission",
    heroTag: "Rural Education Commitment",
    type: "text",
  ...
  "principal-details": {
    slug: "principal-details",
    title: "Principal Details",
    heroTag: "Institution Leadership",
    type: "records",
    intro: "Current principal and official communication details.",
    records: [
      {
        title: "Dr. Abhaya R. Joglekar",
        category: "Principal",
        date: "Mobile: 9425203225 | Fax: 07720-25842x",
        href: "mailto:gbpca1963@gmail.com",
      },
    ],
  },
  "department-list": {
    ...
    records: [
      ...
      { title: "Department of Economics / Political Science / History" },
      { title: "Department of Hindi" },
      { title: "Library" },
      { title: "Sports" },
      { title: "Zoology / Mathematics / Chemistry" },
    ],
  },
  "course-details": {
    slug: "course-details",
    title: "Course Details",
    heroTag: "Programs Offered",
    type: "records",
  ...
  "student-union": {
    slug: "student-union",
    title: "Student Union",
    heroTag: "Student Representation",
    type: "text",
  ...
  "college-samiti": {
    slug: "college-samiti",
    title: "College Samiti",
    heroTag: "Committee Records",
    type: "records",
  ...
  "janbhagidari-samiti-details": {
    slug: "janbhagidari-samiti-details",
    title: "Janbhagidari Samiti",
    heroTag: "Community Governance",
    type: "records",
  ...
  ncc: {
    slug: "ncc",
    title: "NCC",
    heroTag: "Leadership & Discipline",
    type: "text",
    intro: "NCC activities are focused on character, discipline, comradeship, and national values.",
  },
  nss: {
    slug: "nss",
    title: "NSS",
    heroTag: "Community Engagement",
    type: "text",
    intro: "NSS is presented as a student community-service platform supported by the Government of India.",
    content: [
      "Encourages student participation in social outreach and public service programs.",
      "Focuses on experiential learning through community work.",
    ],
  },
  "red-cross": {
    slug: "red-cross",
    title: "Red Cross",
    heroTag: "Health & Service",
    type: "text",
    intro: "The source page currently marks this section as content not available.",
    note: "Content not available on source page at crawl time.",
  },
  "girls-common-room": {
    slug: "girls-common-room",
    title: "Girls Common Room",
    heroTag: "Student Facility",
    type: "text",
    intro: "The source page currently marks this section as content not available.",
    note: "Content not available on source page at crawl time.",
  },
  "smart-class": {
    ...
    heroTag: "Learning Infrastructure",
    type: "text",
    intro: "The source page currently marks this section as content not available.",
    note: "Content not available on source page at crawl time.",
  },
  "botnical-garden": {
    slug: "botnical-garden",
  ...
  "iqac-details": {
    slug: "iqac-details",
    title: "IQAC",
    heroTag: "Internal Quality Assurance",
    type: "records",
    intro: "IQAC repository includes institutional development plans, best practices, and annual reports.",
    records: [
      { title: "IDP 2023-28 Part 1", date: "2025" },
      { title: "IDP 2023-28 Part 2", date: "2025" },
      { title: "Best Practice 2023-24", date: "2025" },
      { title: "Students Feedback Analysis 2023-24", date: "2025" },
      { title: "IIQA Revision", date: "2024" },
      { title: "IQAC Annual Report 2018-19", date: "2024" },
    ],
  },
  "aqar-details": {
    slug: "aqar-details",
    title: "AQAR",
    heroTag: "Annual Quality Assurance Report",
    type: "records",
    intro: "Published AQAR documents from cycle years.",
    records: [
      { title: "AQAR 2023-24 Part 1", date: "2025" },
      { title: "AQAR 2023-24 Part 2", date: "2025" },
      { title: "AQAR 2021-22", date: "2024" },
      { title: "AQAR 2020-21", date: "2023" },
      { title: "AQAR 2019-20", date: "2023" },
      { title: "AQAR 2018-19", date: "2023" },
    ],
  },
  "ssr-details": {
    slug: "ssr-details",
    title: "SSR",
    heroTag: "Self Study Report",
    type: "records",
    intro: "NAAC SSR archive available on the official portal.",
    records: [
      { title: "NAAC SSR 2024", date: "2024" },
      { title: "NAAC SSR 2018", date: "2022" },
    ],
  },
  "peer-team-report-details": {
    slug: "peer-team-report-details",
    title: "Peer Team Report",
    heroTag: "Assessment Records",
    type: "records",
    intro: "Peer team assessment report listing.",
    records: [{ title: "Peer Team Report Cycle 2", date: "2025" }],
  },
  "naac-certificate-details": {
    slug: "naac-certificate-details",
    title: "NAAC Certificate",
    heroTag: "Accreditation",
    type: "text",
  ...
  "naac-feedback-details": {
    slug: "naac-feedback-details",
    title: "Feedback",
    heroTag: "Stakeholder Feedback",
    type: "records",
  ...
  "aish-details": {
    slug: "aish-details",
    title: "AISHE",
    heroTag: "AISHE Compliance",
    type: "records",
    intro: "AISHE certification documents listed on portal.",
    records: [
      { title: "AISHE Certificate 2023-24", date: "2025" },
      { title: "AISHE Certificate 2022", date: "2024" },
    ],
  },
  "important-link-details": {
    slug: "important-link-details",
    title: "Important Links",
    heroTag: "Documents & External References",
    type: "links",
  ...
  event: {
    slug: "event",
    title: "Events",
    heroTag: "Institutional Activities",
    type: "records",
  ...
  "fees-payment": {
    slug: "fees-payment",
    title: "Fees Payment",
    heroTag: "Online Fee Facility",
    type: "links",
    intro: "Source page directs users to SBI Collect for online payment.",
    links: [
      { label: "SBI Collect", href: "https://www.onlinesbi.sbi/sbicollect/icollecthome.htm" },
    ],
  },
  "alumni-details": {
    slug: "alumni-details",
    title: "List Of Alumni",
    heroTag: "Alumni Section",
    type: "records",
    intro: "Alumni records and supporting documents listed on the portal.",
    records: [
      { title: "Alumni Meet", date: "16-12-2023" },
      { title: "Alumni Certificate", date: "04-08-2023" },
      { title: "Gyapan", date: "28-07-2023" },
      { title: "Niyamavali", date: "28-07-2023" },
    ],
  },
  "activities-gallery": {
    ...
    heroTag: "Campus Life",
    type: "gallery",
    intro: "Activity gallery section exists on the official site.",
    note: "Gallery grid appeared without text labels in crawl output.",
  },
  "award-gallery": {
    slug: "award-gallery",
    title: "Award Photo Gallery",
    heroTag: "Achievements",
    type: "gallery",
    intro: "Award gallery section exists on the official site.",
    note: "Gallery grid appeared without text labels in crawl output.",
  },
  "other-gallery": {
    slug: "other-gallery",
    title: "Gallery",
    heroTag: "Visual Archive",
    type: "gallery",
    intro: "Additional media gallery section.",
    note: "Gallery grid appeared without text labels in crawl output.",
  },
  "contact-us": {
    slug: "contact-us",
    title: "Contact Us",
    heroTag: "Reach The College",
    type: "text",
    ...
    links: [
      {
        label: "Open Official Google Map",
        href: "https://www.google.com/maps/place/Badri+Prasad+Lodhi+Govt.College+Arang",
      },
...
export const homeSlides = [
  {
    ...
    image:
      "https://govpgcollarang.cgstate.gov.in/assets/img/silde/College_New_Building_FileArang_17326939409856746cfb4f06f6.jpg",
  },
  {
    ...
    image:
      "https://govpgcollarang.cgstate.gov.in/assets/img/silde/Clg-sport1_FileArang_177383100967669ba8361a50de.jpeg",
  },
  {
    title: "Modern Teaching Spaces and Laboratories",
    subtitle: "Smart classrooms, computer lab, and student-centered learning",
    image:
      "https://govpgcollarang.cgstate.gov.in/assets/img/silde/Computer_Lab_View1_FileArang_17326930311096746cc271aa24.jpg",
  },
];

export const featuredNotices = pages["notice-board"].records ?? [];
export const featuredEvents = pages.event.records ?? [];
